...
const GraphDrawer = require('./controls/graph');
const SelectionSelector = require('./controls/selection-selector');
const CrossoverSelector = require('./controls/crossover-selector');
const MutationSelector = require('./controls/mutation-selector');
const utils = require('./utils');

$(function() {
    const graphDrawer = new GraphDrawer($('#canvas')[0]);
    const selectionSelector = new SelectionSelector();
    const crossoverSelector = new CrossoverSelector();
    const mutationSelector = new MutationSelector();
    let points;
    let tsp;
    let loopId;
    ...
    function render() {
        $('#selection').append(selectionSelector.root);
        $('#crossover').append(crossoverSelector.root);
        $('#mutation').append(mutationSelector.root);
    }
    ...
    function init() {
        ...
        selectionSelector.setup(tsp);
        crossoverSelector.setup(tsp);
        mutationSelector.setup(tsp);
    }
