...
import globalOptions from '../../modules/one-tsp/global-options';
import Preferences from '../../modules/one-tsp/preferences';
...
export default class App extends React.Component {
    ...
    render() {
        return (
            <div className="container p-0" id="app">
                <Header title="TSP: Генетический алгоритм"/>
                <div className="row">
    ...
    renderOptionsInfo() {
        ...
        return (
            <OptionsInfo globalOptions={globalOptions} points={points.length} elitism={elitism} population={population}
